...
const Addteacher = () => {
    ...
    const onInputChange = (event) => {
        ...
        setUser({ ...teach, [event.target.name]: event.target.value })
    };

    const onSubmit = async e => {
        e.preventDefault();
        await axios.post("http://localhost:3004/teach", teach);
            ...
            <div className="container">
                <div className="w-75 mx-auto shadow p-5">
                    ...
                    <form onSubmit={e => onSubmit(e)}>
                        ...
                        <Link className="btn btn- float-right" to="/teacher">Cancel</Link>
                    </form>
